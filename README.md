...
**Last update:** `2026-07-13 00:45:16 UTC`

| Total | HTTP | HTTPS | SOCKS4 | SOCKS5 | Countries | Country&times;Protocol shards |
|---|---|---|---|---|---|---|
| **13,055** | 1,813 | 891 | 451 | 10,791 | 107 | 291 |
<!-- STATS:END -->
...
|---|---|---|---|---|
| **All proxies** | 13,055 | [JSON](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.json) | [TXT](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.txt) | [CSV](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.csv) |
