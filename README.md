...
|---|---|---|---|---|
| **All proxies** | 4,661 | [JSON](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.json) | [TXT](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.txt) | [CSV](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.csv) |
