...
**Last update:** `2026-07-14 02:35:15 UTC`

| Total | HTTP | HTTPS | SOCKS4 | SOCKS5 | Countries | Country&times;Protocol shards |
|---|---|---|---|---|---|---|
| **12,317** | 1,608 | 794 | 359 | 10,350 | 103 | 266 |
<!-- STATS:END -->
...
|---|---|---|---|---|
| **All proxies** | 12,317 | [JSON](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.json) | [TXT](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.txt) | [CSV](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.csv) |
