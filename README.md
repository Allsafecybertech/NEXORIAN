...
|---|---|---|---|---|
| **All proxies** | 3,178 | [JSON](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.json) | [TXT](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.txt) | [CSV](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.csv) |
...
[Browse all 82 countries &rarr;](https://github.com/proxyscrape/free-proxy-list/tree/main/proxies/countries)
<!-- DOWNLOADS:END -->
