...
|---|---|---|---|---|
| **All proxies** | 8,230 | [JSON](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.json) | [TXT](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.txt) | [CSV](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/all/data.csv) |
| HTTP | 1,464 | [JSON](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/protocols/http/data.json) | [TXT](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/protocols/http/data.txt) | [CSV](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/protocols/http/data.csv) |
| HTTPS | 586 | [JSON](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/protocols/https/data.json) | [TXT](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/protocols/https/data.txt) | [CSV](https://cdn.jsdelivr.net/gh/proxyscrape/free-proxy-list@main/proxies/protocols/https/data.csv) |
